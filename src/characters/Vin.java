...
public class Vin extends Character
{
    public Vin()
    {
        ...
        specialDialog = new String[][]{{"entrance", "Jeez. Sweet sweet nostalgia huh. This was the place I did my first show. Now, it's nothing but ruin."},
                ...
                "I...I don't like being here..."}, {"west wing", "This is the worst part for me. Something about the stairwell in the distance...scares me..."}, {"wall", "Can't go that way."}, {"fiend", "the pain..." +
