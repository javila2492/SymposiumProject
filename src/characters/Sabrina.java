...
public class Sabrina extends Character
{
    public Sabrina()
    {
        ...
        specialDialog = new String[][]{{"entrance", "What a dump! Not even the cafeteria's attempt at tacos smell this bad!"}, {"main area", "I played here once! Granted it " +
                ...
                {"supply closet", "There's gotta be something useful in here."}, {"stairwell", "Nope. Not going down there."}, {"west wing a", "Feels like what walking through the empty halls after school feels like."},
                {"west wing b", "Don't like that mist."}, {"wall", "No door here!"}, {"fiend", "Those eyes...I'm getting flashbacks."}};
